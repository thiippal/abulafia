        ...
        task_spec = toloka.project.task_spec.TaskSpec(
            ...
            view_spec=toloka.project.TemplateBuilderViewSpec(
                ...
                config=toloka.project.template_builder.TemplateBuilder(
                    view=toloka.project.template_builder.ListViewV1(
                        items=[toloka.project.template_builder.ImageViewV1(
                            ...
                            validation=None,
                            version='1.0.0'),
                            toloka.project.template_builder.TextViewV1(
                                content='Does the diagram contain text, letters or numbers?',
                                hint=None, label=None, validation=None, version='1.0.0'),
                            toloka.project.template_builder.ButtonRadioGroupFieldV1(
                                data=toloka.project.template_builder.OutputData(path='result', default=None),
                                options=[toloka.project.template_builder.GroupFieldOption(value=True, label='Yes', hint=None),
                                         toloka.project.template_builder.GroupFieldOption(value=False, label='No', hint=None)],
                                hint=None, label=None, validation=toloka.project.template_builder.RequiredConditionV1(
                                    data=None, hint='You must choose one response.', version='1.0.0'), version='1.0.0')],
                        direction=None, size=None, hint=None, label=None, validation=None, version='1.0.0'),
                    plugins=[toloka.project.template_builder.TolokaPluginV1(
                        layout=toloka.project.template_builder.TolokaPluginV1.TolokaPluginLayout(
                            kind='scroll', task_width=500), notifications=None, version='1.0.0'),
                        toloka.project.template_builder.HotkeysPluginV1(
                            key_1=toloka.project.template_builder.SetActionV1(
                                data=toloka.project.template_builder.OutputData(path='result', default=None),
                                payload=True, version='1.0.0'),
                            key_2=toloka.project.template_builder.SetActionV1(
                                data=toloka.project.template_builder.OutputData(path='result', default=None),
                                payload=False, version='1.0.0'), version='1.0.0')], vars=None),
                core_version='1.0.0', infer_data_spec=False))
