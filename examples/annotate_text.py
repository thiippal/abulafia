...
from abulafia.task_specs import TaskSequence, TextAnnotation
import argparse
import json
...
# Define a text annotation task
annotate_text = TextAnnotation(configuration="config/annotate_text.yaml",
                               client=tclient)

# Add the task into a pipeline
pipe = TaskSequence(sequence=[annotate_text], client=tclient)
